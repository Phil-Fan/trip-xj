...
export function PhotoPreview() {
  ...
  return (
    ...
    >
      <div
        className="relative flex max-w-[min(420px,85vw)] flex-col items-center rounded-sm bg-[#fdfbf7] px-3 pt-3 pb-16 shadow-2xl"
        style={{
          boxShadow:
      ...
      >
        ...
        <img
          ...
          className="max-h-[65vh] w-[95%] rounded object-contain"
        />
      </div>
    </div>
  );
